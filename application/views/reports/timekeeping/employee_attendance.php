	...
	<div class="col-sm-15">
		  <div class="panel panel-primary">
		    ...
		    <div class="panel-body">
		    	<!--<a href="<?php echo base_url(); ?>index.php/reports/add_ob" class="btn btn-primary">OB</a>
		    	<a href="<?php echo base_url(); ?>index.php/reports/add_slvl" class="btn btn-primary">SL | VL</a>
		    	<a href="<?php echo base_url(); ?>index.php/reports/add_ot" class="btn btn-primary">OT</a>
		    	<br><br>
		    	-->
		    	 				...
		    	 				<?php if($emp->in_status != 'NO IN' || $emp->out_status != 'NO OUT'): ?>
		    	 					<tr>
			    	 					...
			    	 					<td>
											...
											<td>
												<?php
												if($total_in_min == $total_in_daily && $total_out_daily == $total_out_min)
												{
													echo 'SL/VL';
												}
												elseif($week_date == 1 || $week_date == 2 || $week_date == 3 || $week_date == 4 || $week_date == 5)
												{
													echo 'Regular Day';
												}
												elseif($week_date == 6)
												...
												else
												{
													...
													/*if($week_date == 1 || $week_date == 2 || $week_date == 3 || $week_date == 4 || $week_date == 5) 
													{
														echo 'Regular Day';
													}
													elseif($week_date == 6)
	    	 		...
	    	 		<?php if($slvl) : ?>
	    	 			<?php foreach($slvl as $slvl) : ?>
		    	 			<tr>
		    	 				...
		    	 				<td><?php echo $slvl->effective_date_start ." | " . $slvl->effective_date_end; ?></td>
